...
class Post(models.Model):
    ...
    slug = models.SlugField(max_length=220, unique=True, blank=True, allow_unicode=True, verbose_name='آدرس URL')
    ...
    description = models.CharField(
        max_length=300, verbose_name='توضیح کوتاه',
    ...
    horsepower = models.PositiveIntegerField(null=True, blank=True, verbose_name='قدرت (اسب‌بخار)')
    transmission = models.CharField(max_length=20, choices=TransmissionType.choices, blank=True, verbose_name='گیربکس')
    fuel_type = models.CharField(max_length=20, choices=FuelType.choices, blank=True, verbose_name='نوع سوخت')
